const CACHE_NAME = 'weather-hq-v1.50.0';
...
const PRECACHE_URLS = [
    ...
    'src/services/openMeteo.js?v=1.1.0',
    ...
    'src/services/radarSampler.js?v=1.1.0',
    'lib/jsfive.esm.js',
    'src/services/lightning.js?v=1.0.0',
    'src/services/nowcast.js?v=1.1.0',
    ...
    'src/ui/renderDashboard.js?v=1.14.0',
    'src/ui/tabDrag.js?v=1.1.7',
    'src/main.js?v=1.15.0',
